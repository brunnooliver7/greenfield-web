    ...
    >
      <div className="basis-1/12">
        <div className="p-2.5 mt-1 flex justify-center items-center rounded-md ">
          ...
          <h1 className="text-[15px] ml-3 text-xl text-gray-00 font-bold">
            Greenfield
          </h1>
        </div>
      ...
      <div className="basis-10/12 flex flex-col">
        <Link
          className={`
            ...
            cursor-pointer 
            ${
              homeMenuItemSelected ? 'bg-green-400 text-white' : 'text-gray-600'
            }
            hover:${homeMenuItemSelected ? '' : 'bg-gray-300'}
            hover:pl-3
          `}
          to={'home'}
        >
        ...
        <Link
          className={`
            ...
            hover:${medicoMenuItemSelected ? '' : 'bg-gray-300'}
            hover:pl-3
          `}
          to="medico"
        >
        ...
        <Link
          className={`
            ...
            hover:${pacienteMenuItemSelected ? '' : 'bg-gray-300'}
            hover:pl-3
          `}
          to="paciente"
        >
        ...
        <Link
          className={`
            ...
            hover:${prescricaoMenuItemSelected ? '' : 'bg-gray-300'}
            hover:pl-3
          `}
          to="prescricao"
        >
